...
// var socket = io('https://e2574f66.ngrok.io');

var socket2 = io('https://e2574f66.ngrok.io:4567')
...
socket2.on('connected', function() {
  console.log("chrome connected");
});

socket2.on('chrome', function(data){
  console.log(data);
});
...
function insertWebcam(){

  console.log('loading');


  document.getElementsByTagName('body')[0].innerHTML += "<div id='webcam123'></div>";
